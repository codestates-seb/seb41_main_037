...
public class ProductController {
    ...
    public ResponseEntity post(@Valid @RequestBody ProductDto.Post post) {
        ...
        return new ResponseEntity<>(mapper.entityToResponse(product), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity patch(@PathVariable("product-id") @Positive long productId,
        ...
        Product update = productService.update(mapper.patchToEntity(patch));
    ...
    public ResponseEntity get(@PathVariable("product-id") @Positive long productId) {
        ...
        return new ResponseEntity<>(mapper.entityToResponse(product),HttpStatus.OK);
    }
    ...
    public ResponseEntity gets(@Positive @RequestParam(defaultValue = "1") int page,
        ...
        return new ResponseEntity<>(mapper.entitysToResponses(products), pageProduct, HttpStatus.OK
    }
